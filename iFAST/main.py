...
app.config['MYSQL_USER'] = 'anju'
app.config['MYSQL_PASSWORD'] = 'welcome47!'
app.config['MYSQL_DB'] = 'test_ifast'
app.config['SESSION_COOKIE_EXPIRES'] = False
app.config['UPLOAD_FOLDER'] = "/static/execution_log/"
db = Database(app)
socketio = SocketIO(app)
# Placeholder function for your actual logic to fetch next set of recordsds
...
def newpage():
    ...
    if 'role' in session:
        role = session['role']
    return render_template("ifast.html")
